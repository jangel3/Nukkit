...
public abstract class Entity extends Location implements Metadatable {
    ...
    protected boolean checkObstruction(double x, double y, double z) {
        ...
        if (!Block.transparent.get(this.level.getBlockIdAt(i, j, k))) {
            boolean flag = Block.transparent.get(this.level.getBlockIdAt(i - 1, j, k));
            boolean flag1 = Block.transparent.get(this.level.getBlockIdAt(i + 1, j, k));
            boolean flag2 = Block.transparent.get(this.level.getBlockIdAt(i, j - 1, k));
            boolean flag3 = Block.transparent.get(this.level.getBlockIdAt(i, j + 1, k));
            boolean flag4 = Block.transparent.get(this.level.getBlockIdAt(i, j, k - 1));
            boolean flag5 = Block.transparent.get(this.level.getBlockIdAt(i, j, k + 1));
