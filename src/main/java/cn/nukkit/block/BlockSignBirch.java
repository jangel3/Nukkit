...
public class BlockSignBirch extends BlockTransparentMeta implements Faceable {

    public BlockSignBirch(){
        this(0);
    }

    public BlockSignBirch(int meta){
        super(meta);
    }

    @Override
    public int getId(){
        return BLOCK_BIRCH_SIGN;
    }
