...
public class Item implements Cloneable, BlockID, ItemID {
    ...
    public static Dictionary<Integer, Class> list = null;
    ...
    public static void init() {
        if (list == null) {
            ...
            list = new Hashtable<Integer, Class>();
            ...
            list.put(TOTEM, ItemTotem.class); //450
            ...
            //list.put(DARK_OAK_SIGN, ItemSignDarkOak.class);

            Enumeration<Integer> keys = Block.dicList.keys();
            while (keys.hasMoreElements()){
                Integer key = keys.nextElement();
                list.put(key, Block.dicList.get(key));
            }
